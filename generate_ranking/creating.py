...
create_html_file("CSV/ranking.csv", "public/index.html")
create_html_file("CSV/ploegen.csv", "public/ploegen.html")
create_html_file("CSV/results_with_points.csv", "public/uitslagen.html")
